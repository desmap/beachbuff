" Beachbuff
" A PeachPuff mod from https://github.com/vim/vim/blob/master/runtime/colors/peachpuff.vim
...
hi VertSplit term=reverse cterm=reverse gui=bold guifg=Gray60 guibg=PeachPuff
...
hi SignColumn guifg=Blue guibg=PeachPuff
hi StatusLineNC guifg=Gray60 guibg=PeachPuff
hi StatusLine guifg=Magenta3 guibg=PeachPuff
hi NonText guifg=bg                           
